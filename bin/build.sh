...
for i in ../gateway/gateway.go ../router/router.go ../poster/poster.go ../localposter/localposter.go ../cacheserver/cacheserver.go  ../monitorsystem/monitorserver/monitorserver.go ../client/client.go ../parselog/parselog.go;
do
